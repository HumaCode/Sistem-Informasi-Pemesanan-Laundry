...
<head>
    ...
    <title>Cetak Laporan Pemasukan Bulanan</title>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header text-center">
                            ...
                            <h1 class=" mt-4 mb-3 text-dark">Laporan Bulanan Pemasukan Laundry</h1>
                            <hr>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                            ...
                                            $i = 1;
                                            $sql = $koneksi->query("SELECT * FROM tb_laporan, tb_user WHERE tb_laporan.id_user = tb_user.id AND MONTH(tb_laporan.tgl_masuk) = '$bln' AND YEAR(tb_laporan.tgl_masuk) = '$thn' AND pengeluaran = '0'");
