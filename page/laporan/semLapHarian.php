...
<head>
    ...
    <title>Cetak Semua Laporan Harian</title>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header text-center">
                            ...
                            <h1 class=" mt-4 mb-3 text-dark">Laporan Harian Pemasukan Dan Pengeluaran Laundry</h1>
                            <hr>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                            ...
                                            $i = 1;
                                            $sql = $koneksi->query("SELECT * FROM tb_laporan, tb_user WHERE tb_laporan.id_user = tb_user.id AND DAY(tb_laporan.tgl_masuk) = '$tgl' AND MONTH(tb_laporan.tgl_masuk) = '$bln' AND YEAR(tb_laporan.tgl_masuk) = '$thn'");
                                ...
                                <tr class="text-danger">
                                    <th colspan="5" class="text-center">Saldo Akhir</th>
                                    <td colspan="2" class="text-center"><strong><?= 'Rp. ' . number_format($saldo, 0, ',', '.') ?></strong></td>
                                </tr>
